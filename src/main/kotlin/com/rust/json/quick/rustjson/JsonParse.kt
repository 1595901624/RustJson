...
@Deprecated("use JsonParseUtil instead")
object JsonParse {
...
//            hobbies: []
//         }
    fun parse(jsonElement: JsonElement, structName: String = ""): RustStruct {
        // create rust struct
...
//                val rustStructs = parse(it.value, it.key)
//                rustStruct.fields.addAll(rustStructs)
